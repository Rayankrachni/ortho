                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("انشاء حساب جديد",style: TextStyle(color: Colors.black,fontSize: height*0.026,fontFamily: 'myriadBold'  ),),
                        ...
                        GestureDetector(
                          onTap: (){
                            if(formKey.currentState!.validate()){
                              provider.registerWithEmail(nameCont.text, emailCont.text, passwordCont.text, context);
                            }
