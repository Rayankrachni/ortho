...
import 'package:orthophonienewversion/pages/Result/main-result-page.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      SizedBox(
                                          width: width*0.5,
                                          child: const Text("مرحبًا بك في تطبيق الاختصاص الارطوفوني!",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: primaryColor),textAlign: TextAlign.center,)),
                  ...
                  models.isNotEmpty? Column(
                      children:  filteredModels.map((e) => Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: GestureDetector(
                          onTap: (){
                            push(context: context, screen: MainResultPage(model: e,));
                                ...
                                Padding(
                                  ...
                                  Row(
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Text(e.date!,style:const TextStyle(fontWeight: FontWeight.normal,color: pink,fontSize: 12),),
                                      ),
                                      ...
                                      Container(
                                        ...
                                        child:const Center(child: Icon(Icons.arrow_forward_ios,size: 14,color: Colors.white,)))),
                                    ],
                                  ),
