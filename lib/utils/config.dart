...
const primaryColor = Color(0xff4202ba);
...
const pinklight = Color(0xfff479bb);

const indigoColor = Color(0xff1f0151);
const indigoSecondColor = Color(0xffc6b5ed);
const indigothirdColor = Color(0xff7db3de);
