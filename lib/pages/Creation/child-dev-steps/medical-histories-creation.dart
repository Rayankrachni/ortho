...
class MedicalHistoriesCreation extends StatefulWidget {
  const MedicalHistoriesCreation({super.key});

  @override
  State<MedicalHistoriesCreation> createState() => _MedicalHistoriesCreationState();
}

class _MedicalHistoriesCreationState extends State<MedicalHistoriesCreation> {
